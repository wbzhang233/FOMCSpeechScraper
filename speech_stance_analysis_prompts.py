...
QWEN2_PROMPT_ENG = {
    ...
    "output_format": {
        "classification": "The classified stance (Hawkish, Leaning Hawkish, Balanced, Leaning Dovish, Dovish).",
